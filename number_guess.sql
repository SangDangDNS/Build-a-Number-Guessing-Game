...
--
-- Name: number_guess; Type: DATABASE; Schema: -; Owner: root
--

CREATE DATABASE number_guess WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE = 'en_US.utf8';


ALTER DATABASE number_guess OWNER TO root;
...
INSERT INTO public.users VALUES (1, 'Sang');
INSERT INTO public.users VALUES (2, 'An');
...
--
-- Name: games games_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: root
--
